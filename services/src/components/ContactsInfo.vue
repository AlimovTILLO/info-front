              ...
              <div class="col-md-5">
                <div class="contactsInfo__profile">
                  <div class="contactsInfo__fotoWrap">
                    <div class="contactsInfo__foto"><img :src="profile.main_image" alt=""></div>
...
export default {
  ...
  methods: {
    ...mapActions(
      // 'items', {getUser: 'getUser'},
      'account', {updateProfile: 'updateProfile'}
    ),
    submitForm (e) {
      let formData = new FormData()
      formData.append('image', this.profile.main_image)
    ...
    handleImageUpload () {
      this.profile.main_image = this.$refs.img.files[0]
    },
    update () {
    }
  }
