            ...
            <div class="row">
              ...
              <div class="col-md-5">
                <div class="contactsInfo__detail">
                  <div class="contactsInfo__inputWrap"><i class="icon-user"></i> <input type="text"
                      class="registration__input registration__input--registrationInput" name="Имя" placeholder="Имя">
                  </div>
                  <div class="contactsInfo__inputWrap"><i class="icon-envelope"></i> <input type="text"
                      class="registration__input registration__input--registrationInput" name="Email"
                  ...
                  <div class="contactsInfo__inputWrap"><i class="icon-phone"></i> <input type="text"
                      ...
                      placeholder="+996 999 999" name="Телефон"></div><button type="submit"
                    class="btn">Сохранить</button>
                </div>
              </div>
            </div>
          </form>
