<template>
  <div class="registration blurEffect ">
    <div class="registration__modalWindow">
      ...
      <div class="registration__registrationSide contentWrap--atherBgc" id="block2">
        <form @submit.prevent="handleSubmit">
          ...
          <div class="filter__selectWrap">
            <div class="row">
              <div class="col-md-7">
                <div
                  class="filter__select addCategory-js"
                  @click="isSectionsItemActive=true"
                  v-on-clickaway="isSectionDropdown"
                >
                  ...
                  >
                    {{ category.name.ru }}
                    <i
                      v-on:click="removeSectionItem(category)"
                      class="fal fa-times deleteCategory-js"
                    ></i>
                  </div>
                </div>
              </div>
            ...
            <div
              class="filter__sections"
              v-bind:style="isSectionsItemActive ? 'display: block;' : 'display: none;'"
            >
              <div
                v-for="category in categories"
                v-bind:key="category.id"
                class="filter__sectionsItem"
                data-value="category.name.ru"
              >
                <div v-on:click="AddSectionItem(category)" class="filter__iconWrap">
                  <div class="filter__icon">
                    <img
                      v-if="category.medias"
                      :src="category.medias.thumb_128"
          ...
          <div class="filter__inputFile">
            <div class="uploadbutton">
              <div class="input-file-text">
                <i class="fal fa-paperclip"></i>Прикрепить фото
              </div>
              <input
                name="files"
                class="input-file"
